...
public class FactCheckServiceImpl implements FactCheckService {
	...
	private static final String OPENROUTER_API_KEY = "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"; // Store
	 private static final String GOOGLE_FACT_CHECK_API_URL = "https://factchecktools.googleapis.com/v1alpha1/claims:search";
	    private static final String GOOGLE_API_KEY = "AIzaSyDRzwr2655-5v2zQuM-vV968KJCSwXAJKs"; 
	...
	private FactCheckResult queryOpenRouter(String claim, String model) {
		...
		try {
			ResponseEntity<String> response = restTemplate.exchange(OPENROUTER_API_URL, HttpMethod.POST, requestEntity,
					String.class);
	...
	private Set<String> fetchFactCheckSources(String claim) {
	    String url = GOOGLE_FACT_CHECK_API_URL + "?query=" + claim + "&key=" + GOOGLE_API_KEY;
	    try {
